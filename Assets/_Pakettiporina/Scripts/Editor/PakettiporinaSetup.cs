...
namespace Pakettiporina.EditorTools
{
    ...
    public static class PakettiporinaSetup
    {
        ...
        [MenuItem("Pakettiporina/2 - KORJAA peliscene")]
        ...
        static void Run(bool fix)
        {
            ...
            if (startObj != null && fix)
            {
                ...
                startObj.transform.position = new Vector3(0f, START_Y, START_Z);
            ...
            else
            {
                ...
                if (fix)
                {
                    ...
                    carGo.transform.position = new Vector3(0f, START_Y, START_Z);
            ...
            else
            {
                ...
                if (fix)
                {
                    ...
                    fgo.transform.position = new Vector3(0f, 0f, FINISH_Z);
